...
There are many steps and flavors to glider data processing, from the base processing (binary glider to NetCDF files for Slocum gliders), to QA/QC, to developing products from additional glider sensors. This page outlines the ESD glider lab's data processing, and in particular base processing workflow and data products.

Users interested in understanding and accessing data products created for each deployment should see the [Data Products](#data-products) section.
