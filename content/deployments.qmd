...
- **timeseries-sci**, **gridded-5m**, **imagery-csv**: Selected products from the ['base' glider processing](glider-data.qmd#base-processing) workflow.
...
- **glider**: All glider-related data products from the ['base' glider processing](glider-data.qmd#base-processing) workflow. 
