...
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vR1QEPFK9em24JT6-9p2MeW6Va6srqITFqsYpiF7x-QBAKdwYw4zeuJFOxjHr-4eeDRGzO-8Z0uE1z4/pubhtml?widget=true&amp;headers=false"style="width:700px; height:500px; border: 2px solid black;"></iframe>

(In progress: rather than displaying an embedded sheet, use R code to make a pretty table)

## Deployment Reports

Internal ESD glider deployment reports. Developing public-facing reports are in progress.
