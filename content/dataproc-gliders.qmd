...
This section describes these current efforts, and outlines planned areas of future development. For acoustic or image processing workflows, see here (todo) and here (todo), respectively.
...
3. Access processed NetCDF files via GCP.
