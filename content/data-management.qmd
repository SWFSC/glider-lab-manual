...
The [glider-lab](https://github.com/SWFSC/glider-lab) repository has evoloved into a place to store a) reference documents that can be accessible to folks outside NOAA and b) files used for processing in GCP. These include:
