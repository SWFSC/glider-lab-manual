...
This section replaces the [AMLR Glider Data Management Plan](https://docs.google.com/document/d/1dW5ZdkOpTz59xy4xs8ypVOvGLWBYZMdlbwGJty4PTV0/edit?usp=sharing) Google doc. It describes what files go where, as well as required directory structures.
...
Other files assocaited with a deployment (e.g., autoexec and proglet files, or config files assocaited with certain instruments) are currently stored in the database, but will likely be moved to a more accessible location in the future.

###  glider-lab repository

The [glider-lab](https://github.com/SWFSC/glider-lab) repository has evloved into a place to store a) reference documents that need to be accessible to folks outside NOAA and b) files used for processing in GCP. These include:
...
- Several folders contain "delayed" and "rt" subfolders. Delayed mode data represents data that were  collected or generated after the glider was recovered, while rt (i.e., realtime) represents data that were transmitted or generated while the glider was deployed.
