...
5.  If a lab member feels their safety concerns are not being taken seriously, or have any other lab safety questions, they can consult the SWFSC Safety Officer Ravi Shiwmangal ([ravi.shiwmangal@noaa.gov](mailto:ravi.shiwmangal@noaa.gov)).
...
1. If using VSCode, [this page](https://quarto.org/docs/tools/vscode.html) contains helpful references and shortcuts. One of the most common and important is to [render and preview](https://quarto.org/docs/tools/vscode.html#render-and-preview) the current qaurto files, which you can do with the <kbd>Ctrl+Shift+K</kbd> keyboard shortcut.