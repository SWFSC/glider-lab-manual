...
There are many steps and flavors to slocum glider data processing, from the base processing (binary files to NetCDF for Slocum gliders), to QA/QC, to developing additional data products. This page outlines the ESD glider lab's data processing workflow, in particular base processing and data products. 
...
The `binary_to_nc` function is the workhorse of the esdglider base processing for Slocum gliders
